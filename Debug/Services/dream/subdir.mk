...
C_SRCS += \
../Services/dream/dream_sysex.c 

OBJS += \
./Services/dream/dream_sysex.o 

C_DEPS += \
./Services/dream/dream_sysex.d 


# Each subdirectory must supply rules for building sources it contributes
Services/dream/%.o Services/dream/%.su Services/dream/%.cyclo: ../Services/dream/%.c Services/dream/subdir.mk
...
clean: clean-Services-2f-dream

clean-Services-2f-dream:
	-$(RM) ./Services/dream/dream_sysex.cyclo ./Services/dream/dream_sysex.d ./Services/dream/dream_sysex.o ./Services/dream/dream_sysex.su

.PHONY: clean-Services-2f-dream
