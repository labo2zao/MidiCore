...
C_SRCS += \
../Services/humanize/humanize.c 

OBJS += \
./Services/humanize/humanize.o 

C_DEPS += \
./Services/humanize/humanize.d 


# Each subdirectory must supply rules for building sources it contributes
Services/humanize/%.o Services/humanize/%.su Services/humanize/%.cyclo: ../Services/humanize/%.c Services/humanize/subdir.mk
...
clean: clean-Services-2f-humanize

clean-Services-2f-humanize:
	-$(RM) ./Services/humanize/humanize.cyclo ./Services/humanize/humanize.d ./Services/humanize/humanize.o ./Services/humanize/humanize.su

.PHONY: clean-Services-2f-humanize
