...
Services/log/%.o Services/log/%.su Services/log/%.cyclo: ../Services/log/%.c Services/log/subdir.mk
...
clean: clean-Services-2f-log

clean-Services-2f-log:
	-$(RM) ./Services/log/log.cyclo ./Services/log/log.d ./Services/log/log.o ./Services/log/log.su

.PHONY: clean-Services-2f-log
