...
Services/config/%.o Services/config/%.su Services/config/%.cyclo: ../Services/config/%.c Services/config/subdir.mk
...
clean: clean-Services-2f-config

clean-Services-2f-config:
	-$(RM) ./Services/config/config.cyclo ./Services/config/config.d ./Services/config/config.o ./Services/config/config.su

.PHONY: clean-Services-2f-config
