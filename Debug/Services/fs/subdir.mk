...
C_SRCS += \
../Services/fs/fs_atomic.c \
../Services/fs/sd_guard.c 

OBJS += \
./Services/fs/fs_atomic.o \
./Services/fs/sd_guard.o 

C_DEPS += \
./Services/fs/fs_atomic.d \
./Services/fs/sd_guard.d 


# Each subdirectory must supply rules for building sources it contributes
Services/fs/%.o Services/fs/%.su Services/fs/%.cyclo: ../Services/fs/%.c Services/fs/subdir.mk
...
clean: clean-Services-2f-fs

clean-Services-2f-fs:
	-$(RM) ./Services/fs/fs_atomic.cyclo ./Services/fs/fs_atomic.d ./Services/fs/fs_atomic.o ./Services/fs/fs_atomic.su ./Services/fs/sd_guard.cyclo ./Services/fs/sd_guard.d ./Services/fs/sd_guard.o ./Services/fs/sd_guard.su

.PHONY: clean-Services-2f-fs
