...
OBJS += \
./Services/input/input.o 

C_DEPS += \
./Services/input/input.d 


# Each subdirectory must supply rules for building sources it contributes
Services/input/%.o Services/input/%.su Services/input/%.cyclo: ../Services/input/%.c Services/input/subdir.mk
...
clean: clean-Services-2f-input

clean-Services-2f-input:
	-$(RM) ./Services/input/input.cyclo ./Services/input/input.d ./Services/input/input.o ./Services/input/input.su

.PHONY: clean-Services-2f-input
