...
OBJS += \
./Services/zones/zones_cfg.o 

C_DEPS += \
./Services/zones/zones_cfg.d 


# Each subdirectory must supply rules for building sources it contributes
Services/zones/%.o Services/zones/%.su Services/zones/%.cyclo: ../Services/zones/%.c Services/zones/subdir.mk
...
clean: clean-Services-2f-zones

clean-Services-2f-zones:
	-$(RM) ./Services/zones/zones_cfg.cyclo ./Services/zones/zones_cfg.d ./Services/zones/zones_cfg.o ./Services/zones/zones_cfg.su

.PHONY: clean-Services-2f-zones
