...
OBJS += \
./Services/safe/safe_mode.o 

C_DEPS += \
./Services/safe/safe_mode.d 


# Each subdirectory must supply rules for building sources it contributes
Services/safe/%.o Services/safe/%.su Services/safe/%.cyclo: ../Services/safe/%.c Services/safe/subdir.mk
...
clean: clean-Services-2f-safe

clean-Services-2f-safe:
	-$(RM) ./Services/safe/safe_mode.cyclo ./Services/safe/safe_mode.d ./Services/safe/safe_mode.o ./Services/safe/safe_mode.su

.PHONY: clean-Services-2f-safe
