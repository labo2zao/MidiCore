 ...
 * 
 * Usage:
 *   1. Call midicore_hooks_init() during system initialization
 *   2. Use midicore_hooks_write() for thread-safe terminal output
 *   3. Use midicore_hooks_read() for thread-safe terminal input
 * 
 * MidiCore Compatibility:
 * - Matches MidiCore terminal architecture
 ...
 * Must be paired with midicore_hooks_unlock().
 * 
 ...
 * Must be called after successful midicore_hooks_lock().
 */
