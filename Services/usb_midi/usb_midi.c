...
/* Stub implementations when USB Device MIDI is not enabled */
void usb_midi_init(void) {}

void usb_midi_send_packet(uint8_t cin, uint8_t b0, uint8_t b1, uint8_t b2) {
  (void)cin; (void)b0; (void)b1; (void)b2;
  /* Stub: USB Device MIDI not enabled in module_config.h */
}

void usb_midi_rx_packet(const uint8_t packet4[4]) {
  (void)packet4;
  /* Stub: USB Device MIDI not enabled */
}

#endif /* MODULE_ENABLE_USB_MIDI */
