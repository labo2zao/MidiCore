...
#if MODULE_ENABLE_USB_MIDI && defined(__has_include)
...
/* Fallback: try to include but will fail if files don't exist */
#  if __has_include
#    if __has_include("usb_device.h")
#      include "usb_device.h"
#      include "usbd_midi.h"
...
#    endif
#  else
/* Compiler doesn't support __has_include, assume files don't exist */
#    define USB_DEVICE_AVAILABLE 0
#  endif
#else
#  define USB_DEVICE_AVAILABLE 0
...
#if MODULE_ENABLE_USB_MIDI && USB_DEVICE_AVAILABLE
